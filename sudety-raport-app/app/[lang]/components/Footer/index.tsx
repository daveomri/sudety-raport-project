      ...
      <div className='mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8'>
        <div className='md:flex md:justify-between'>
          <div className='mb-6 md:mb-0'>
            ...
            <Image width='150' height='450' src='/logo.png' alt='sudety-raport-logo' />
              {/* <span className='self-center text-2xl font-serif font-thin whitespace-nowrap dark:text-white'>Sudety Raport</span> */}
            </a>
          </div>
          <div className='grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3'>
            <div>
              ...
              <ul className='text-gray:500 dark:text-gray-400 font-medium'>
                <li className='mb-4'>
                  <a href='#' className='hover:underline font-medium hover:text-red-600 text-red-400'>Buy me a coffee</a>
                </li>
                <li>
                  <a href='#' className='hover:underline'>Patreon</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className='sm:flex sm:items-center sm:justify-between'>
          ...
          <div className='flex mt-4 sm:justify-center sm:mt-0'>
              ...
              <a href='#' className='fill-gray-500 hover:fill-text-gray-900 dark:hover:fill-white ms-5'>
